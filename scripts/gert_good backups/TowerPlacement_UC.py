...
def makeTowersAndJunctions(inTowerPlacementLine):
...
#            includedTransmissionLinesFC = os.path.join(lc_scratch_ws, transmission_line_name)
            ...
            towerPlacementPoints_basename = os.path.basename(inTowerPlacementLine) + "_3D"
            ...
            if arcpy.Exists(towerPlacementPoints):
                arcpy.Delete_management(outSpansFromScript)
        ...
        arcpy.management.TruncateTable("TowerModels")
...
if __name__ == '__main__':
    ...
    makeTowersAndJunctions(inTowerPlacementLine)
